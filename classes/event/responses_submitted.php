...
namespace catquizcentralhub_client\event;

use local_catquiz\event\catquiz_event_base;
use moodle_url;

/**
 * Fired when this node successfully submits responses to the central hub.
 *
 * @package catquizcentralhub_client
 * @copyright 2024 Wunderbyte GmbH <info@wunderbyte.at>
 * @license http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
...
class responses_submitted extends catquiz_event_base {
    ...
    public static function get_name() {
        return get_string('responses_submitted', 'catquizcentralhub_client');
    }
    ...
    public function get_description() {
        ...
        return get_string('responses_submitted_desc', 'catquizcentralhub_client', $data);
    }
